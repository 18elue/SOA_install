#************************************************************************
# File: create_soa_domain.py
#
# Description:
# This WLST script generates a SOA domain, it reads in the property file
# wls_input.properties and osb_soa_input.properties as input.
#
# Author: yelu
# Version:0.1
#************************************************************************
...
def init():
    ...
    addTemplate(BEAHOME + '/Oracle_SOA1/common/templates/applications/oracle.soa_template_11.1.1.jar')
    addTemplate(BEAHOME + '/oracle_common/common/templates/applications/oracle.em_11_1_1_0_0_template.jar')
    print 'add SOA template finished'
...
def set_JDBC():
    datasource_detail = {
        ...
        'mds-owsm' : 'MDS',
        'mds-soa' : 'MDS',
        'OraSDPMDataSource' : 'ORASDPM'
    }
    for ds in datasource_detail.keys():
